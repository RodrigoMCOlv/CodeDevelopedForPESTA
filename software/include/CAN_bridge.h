...
static uint32_t one_way_restricted_ids[MAX_LIST_SIZE]; //FILTER_MODE_BIDIRECTIONAL_EXCEPT_OW_1_TO_0 385 dead, 285 dead, 205 still moves, 185 dead, 6a2 still moves
